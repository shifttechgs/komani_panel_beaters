            ...
            <div class="row align-items-center">
                <div class="col-md-12 col-xl-4">
                    <div class="pbmit-footer-logo">
                        <img src="assets/images/konami_logo.png" alt="">
                    </div>
                </div>
                ...
                <div class="pbmit-footer-widget-col-4 col-md-3">
                    <aside class="widget">
                        ...
                        <div class="pbmit-contact-widget-lines">
                            <div class="pbmit-contact-widget-line pbmit-contact-widget-phone">045 839 6285</div>
    ...
    <div class="pbmit-footer-text-area">
        <div class="container">
            <div class="pbmit-footer-text-inner">
                <div class="row">
                    <div class="col-md-12">
                        <div class="pbmit-footer-copyright-text-area"> Copyright © <script>document.write(new Date().getFullYear())</script> <a href="#">Komani Panel Beaters</a>, All Rights Reserved. <a href="https://shifttechgs.com/">Powered By ShiftTech</a></div>
                    </div>
                </div>
            </div>
        </div>
